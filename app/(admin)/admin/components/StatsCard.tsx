  ...
  return (
    <div className="bg-white dark:bg-stone-900 p-6 rounded-xl border border-stone-200 dark:border-stone-800 shadow-sm">
      <div className="flex items-start justify-between">
        <div>
          <p className="text-sm font-medium text-stone-500 dark:text-stone-500">{title}</p>
          <h3 className="text-2xl font-bold text-stone-900 dark:text-stone-100 mt-1">{value}</h3>
        </div>
        <div className="p-2 bg-stone-50 dark:bg-stone-950 rounded-lg border border-stone-100">
